  ...
  "group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
        ...
        muted:
          "*:data-[slot=bubble-content]:bg-muted [&>[data-slot=bubble-content]:is(button,a):hover]:bg-surface-hover-strong",
        tinted:
          "*:data-[slot=bubble-content]:bg-primary-muted *:data-[slot=bubble-content]:text-foreground [&>[data-slot=bubble-content]:is(button,a):hover]:bg-primary-selected",
        outline:
        ...
        destructive:
          "*:data-[slot=bubble-content]:bg-error-surface *:data-[slot=bubble-content]:text-destructive [&>[data-slot=bubble-content]:is(button,a):hover]:bg-error-surface-hover",
      },
    },
    defaultVariants: {
      variant: "default",
