...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-focus focus-visible:ring-3 focus-visible:ring-focus-ring active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-error-border aria-invalid:ring-3 aria-invalid:ring-error-ring [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-hover",
        outline:
          "border-control-border bg-control-background hover:bg-control-background-hover hover:text-foreground aria-expanded:bg-control-background-hover aria-expanded:text-foreground",
        secondary:
        ...
        destructive:
          "bg-error-surface text-destructive hover:bg-error-surface-hover focus-visible:border-error-border-focus focus-visible:ring-error-ring",
